	...
	{foreach from=$menus item=menu}
		<div class="manager-list{cycle values=', gray-bg'}">
			...
			<div class="manager-list-controls">
				...
				<a href="/manager/menus/edit/id/{$menu->menu_id}"><img src="/images/admin/edit.png" alt="Редактировать" /></a>
				{if !$menu->locked}<a href="/manager/menus/delete/id/{$menu->menu_id}"><img src="/images/admin/delete.png" alt="Удалить" /></a>{/if}
			</div>
